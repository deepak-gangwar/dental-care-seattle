...
export default function FooterCurve({ color }) {
    return (
        <div id='footer-curve' className={styles.footer_rounded_div}>
            <div className={`${styles.overlay} ${styles.overlay__gradient}`}></div>

            <svg className={`${styles.separator} ${styles.separator__up}`} style={{ fill: color }} width="100%" height="100%" viewBox="0 0 100 10" preserveAspectRatio="none">
                <path
