    ...
    return (
        <>
            ...
            <section className={styles.carousel}>
                ...
                <h2 className={styles.heading__lg}>Booking</h2>
                <h2 className={styles.heading__lg}>Invisalign</h2>
                <h2 className={styles.heading__lg}>Your Visit</h2>

                {/* ================ INDICATOR ================ */}
                <span className={styles.indicator__wrap}>
                    <div className={styles.indicator__bar}>
                        <div className={styles.indicator}></div>
                        <div className={styles.indicator__progress}></div>
                    </div>

                    <div className={styles.indicator__num}>
                        <span className={styles.num__current}>1</span>
                        <span className={styles.num__separator}>/</span>
                        <span className={styles.num__total}>3</span>
                    </div>
                </span>
                ...
                <div className={styles.questions__wrap}>
                    <Accordion section={"booking"} />
                </div>
                <div className={styles.questions__wrap}>
                    <Accordion section={"invisalign"} />
                </div>
                <div className={styles.questions__wrap}>
